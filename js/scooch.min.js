/*! scooch 0.3.4 2014-04-10 */
var Mobify = window.Mobify = window.Mobify || {};
Mobify.$ = Mobify.$ || window.Zepto || window.jQuery, Mobify.UI = Mobify.UI ? Mobify.$.extend(Mobify.UI, {
    classPrefix: "m-"
}) : {
    classPrefix: "m-"
},
function (t, e) {
    t.support = t.support || {}, t.extend(t.support, {
        touch: "ontouchend" in e
    })
}(Mobify.$, document), Mobify.UI.Utils = function (t) {
    var e = {},
        i = t.support,
    ...
    e.events = i.touch ? {
        ...
        for (var e = ["Webkit", "Moz", "O", "ms", ""], i = document.createElement("div").style, n = 0; e.length > n; ++n)
...
}(Mobify.$), Mobify.UI.Scooch = function (t, e) {
    var i = {
            dragRadius: 10,
            moveRadius: 20,
            animate: !0,
    ...
    return s.defaults = i, s.prototype.setOptions = function (e) {
        var n = this.options || t.extend({}, i, e);
        n.classNames = t.extend({}, n.classNames, e.classNames || {}), n.classPrefix === void 0 && (n.classPrefix = Mobify.UI.classPrefix), this.options = n
        ...
        if (t !== void 0 && this._updateCallbacks.push(t), !this._needsUpdate) {
            this._needsUpdate = !0;
            var i = this;
            e.requestAnimationFrame(function () {
                i._update(), setTimeout(function () {
                    for (var t = 0, e = i._updateCallbacks.length; e > t; t++) i._updateCallbacks[t].call(i);
                    i._updateCallbacks = []
                }, 10)
            })
        }
        ...
        function i(t) {
            n.touch || t.preventDefault(), d = !0, f = !1, r = e.getCursorPosition(t), h = 0, u = 0, l = !1, p._disableAnimation(), v = 1 == p._index, $ = p._index == p._length
        }
        ...
        function s(t) {
            if (d && !f) {
                var i = e.getCursorPosition(t),
                    n = p.$element.width();
                h = r.x - i.x, u = r.y - i.y, l || c(h) > c(u) && c(h) > m ? (l = !0, t.preventDefault(), v && 0 > h ? h = h * -n / (h - n) : $ && h > 0 && (h = h * n / (h + n)), p._offsetDrag = -h, p.update()) : c(u) > c(h) && c(u) > m && (f = !0)
            }
        }

        function o() {
            d && (d = !1, p._enableAnimation(), !f && c(h) > _.moveRadius ? h > 0 ? p.next() : p.prev() : (p._offsetDrag = 0, p.update()))
        }

        function a(t) {
            l && t.preventDefault()
        }
        var r, h, u, l, c = Math.abs,
            d = !1,
            f = !1,
            ...
            $ = !1,
            b = t(window).width();
        y.on(e.events.down + ".scooch", i).on(e.events.move + ".scooch", s).on(e.events.up + ".scooch", o).on("click.scooch", a).on("mouseout.scooch", o), g.on("click", "[data-m-slide]", function (e) {
            e.preventDefault();
            var i = t(this).attr("data-m-slide"),
                n = parseInt(i, 10);
            isNaN(n) ? p[i]() : p.move(n)
        }), g.on("afterSlide", function (t, e, i) {
            p.$items.eq(e - 1).removeClass(p._getClass("active")), p.$items.eq(i - 1).addClass(p._getClass("active")), p.$element.find("[data-m-slide='" + e + "']").removeClass(p._getClass("active")), p.$element.find("[data-m-slide='" + i + "']").addClass(p._getClass("active"))
        }), t(window).on("resize orientationchange", function () {
            b != t(window).width() && (p._disableAnimation(), b = t(window).width(), p.update())
        }), g.trigger("beforeSlide", [1, 1]), g.trigger("afterSlide", [1, 1]), p.update()
    ...
    }, s.prototype.move = function (e, i) {
        var n = this.$element,
            s = (this.$inner, this.$items),
            o = (this.$start, this.$current),
            a = this._length,
            r = this._index;
        i = t.extend({}, this.options, i), 1 > e ? e = 1 : e > this._length && (e = a), e == this._index, i.animate ? this._enableAnimation() : this._disableAnimation(), n.trigger("beforeSlide", [r, e]), this.$current = o = s.eq(e - 1), this._offsetDrag = 0, this._index = e, i.animate ? this.update() : this.update(function () {
            this._enableAnimation()
        }), n.trigger("afterSlide", [r, e])
...
function (t) {
    t.fn.scooch = function (e, i) {
        var n = t.extend({}, t.fn.scooch.defaults);
        "object" == typeof e && (t.extend(n, e, !0), i = null, e = null);
        var i = Array.prototype.slice.apply(arguments);
        return this.each(function () {
            var s = (t(this), this._scooch);
            s || (s = new Mobify.UI.Scooch(this, n)), e && (s[e].apply(s, i.slice(1)), "destroy" === e && (s = null)), this._scooch = s
        }), this
